...
\label{E:dSc}
 ...
 %
 \frac{dS^{c}_{w}}{dt} &=& p_{t}p_{c} S + p^{c}_{t} S^{c} - [\frac{1}{\tau_{t}} + \gamma_{iso}] S^{c}_{w}, \\ 
 %
...
\begin{eqnarray}
\label{E:dEc}
 \frac{dE^{c}}{dt} &=& \gamma_{iso} S^{c} + \gamma^{c} p_{c} E -[p^{c}_{t} +\frac{1}{\tau_{iso}} + \frac{1}{\tau_{inc}}] E^{c}, \\
 %
 \frac{dE^{c}_{w}}{dt} &=& \gamma_{iso} S^{c}_{w} + p_{t}p_{c} E + p^{c}_{t}E^{c} - [\frac{1}{\tau_{t}}  + \frac{1}{\tau_{inc}}] E^{c}_{w}, \\ 
 %
...
\label{E:dIc}
 ...
 %.
 \frac{dN^{c}_{I'}}{dt} &=&  \frac{1}{\tau_{inc}} [N^{c}_{E} + N^{c}_{E'}] - [\frac{1}{\tau_{inf}} + \frac{1}{\tau_{iso}}] N^{c}_{I'}.
\end{eqnarray}
